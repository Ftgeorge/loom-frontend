...
export function AppHeader({
    ...
    return (
        <View
            className="flex-row items-center justify-between px-5 pb-4 bg-background border-b border-gray-200"
            ...
            <View className="flex-row items-center gap-3 flex-1">
                ...
                {showLocation && (
                    <View className="flex-row items-center gap-1">
                        ...
                        <Text className="text-lg font-semibold text-primary m-0">{selectedCity}</Text>
                        <Ionicons name="chevron-down" size={16} color="#71717A" />
                    </View>
                )}
                {title && !showLocation && (
                    <Text className="text-xl font-bold text-primary m-0">{title}</Text>
                )}
            </View>
